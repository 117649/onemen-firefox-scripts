...
export class ChromeManifest {
  ...
  /**
   * Output the manifest data as a string in chrome.manifest format If root is
   * provided, convert all relative locations to absolute paths.
   *
   * @param {String} [root] The absolute path root to resolve relative locations
   * @returns {String} The manifest contents as a string
   */
  toString(root = '') {
    const lines = [];
